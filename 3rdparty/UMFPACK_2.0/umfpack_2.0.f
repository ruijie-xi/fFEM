...
c
cc UMS2LT is a utility routine which solves a lower triangular system.
c
...
c
cc LSAME determines whether two characters are equal.
c
*
...
c
cc MC13E permutes a sparse matrix to block triangular form.
c
      integer stp,dummy
      integer ip(n)
c
...
c
cc MC21B permutes a sparse matrix to put entries on the diagonal.
c
      integer ip(n)
...
c
cc XERBLA is an error handler for LAPACK routines.
c
*
