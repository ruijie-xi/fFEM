...
contains
    ...
    subroutine AssembleMatrixElement(coe_fun, Th, Vh_trial, Vh_test, assemble_info, Gauss_type, errpetsc, A)
        ...
        real(8),dimension(:,:),allocatable :: local_mat, local_mat_t
    ...
    subroutine AssembleVectorElement(coe_fun, Th, Vh_test, assemble_info, Gauss_type, errpetsc, b)
        procedure(func) :: coe_fun
        type(mesh2D),intent(in) :: Th
