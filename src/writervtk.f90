...
!***********************************************************************************************************************
    SUBROUTINE writeoutputvtk(ndim,nElem,nNode,npElem,ndof, coords,elemNodeConn,elem_procid,soln,fileName)
    ...
    ELSE
      DO ii=1,nNode
        write(1,'(F12.6,F12.6,F12.6)') coords(1,ii), coords(2,ii), coords(3,ii)
      END DO
    END IF
    ...
    IF(ndim == 2) THEN
      IF(npElem == 3) THEN
        ...
        n1 = 5
        DO ee=1,nElem
          write(1,'(I10,I10,I10,I10)') npElem,elemNodeConn(1,ee)-1,elemNodeConn(2,ee)-1,elemNodeConn(3,ee)-1
        END DO
      ELSE IF(npElem == 6) THEN
        ! Quadratic Triangular element
        n1 = 22
        DO ee=1,nElem
          write(1,'(I10,I10,I10,I10,I10,I10,I10)') npElem,elemNodeConn(1,ee)-1,elemNodeConn(2,ee)-1, &
          elemNodeConn(3,ee)-1,elemNodeConn(4,ee)-1,elemNodeConn(5,ee)-1,elemNodeConn(6,ee)-1
        END DO
      ELSE
        ! Quadrilateral element
        n1 = 9
        DO ee=1,nElem
          write(1,'(I10,I10,I10,I10,I10)') npElem,elemNodeConn(1,ee)-1, elemNodeConn(2,ee)-1,elemNodeConn(3,ee)-1,&
          elemNodeConn(4,ee)-1
        END DO
      END IF
    ELSE ! ndim=3
      IF(npElem == 4) THEN
        ...
        n1 = 10
        DO ee=1,nElem
          write(1,'(I10,I10,I10,I10,I10)') npElem,elemNodeConn(1,ee)-1,elemNodeConn(2,ee)-1,&
          elemNodeConn(3,ee)-1,elemNodeConn(4,ee)-1
        END DO
      ELSE IF(npElem == 6) THEN
        ! Prism/Wedge element
        n1 = 13
